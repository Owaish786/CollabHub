    ...
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-[45%] flex-col justify-between bg-indigo-600 p-12 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <p className="text-2xl font-semibold leading-tight text-white">
            &ldquo;The fastest way to keep your team in sync.&rdquo;
          </p>
          <p className="mt-3 text-sm text-indigo-200">Real-time collaboration, built for modern teams.</p>
        </div>
      </div>
      ...
      <div className="flex flex-1 flex-col items-center justify-center bg-white px-6 py-12">
        <div className="animate-fade-up w-full max-w-sm">
          ...
          {/* Warning banner */}
          {authStatus?.warnings?.length ? (
            <div className="mb-5 rounded-lg border border-amber-200 bg-amber-50 px-4 py-3 text-sm text-amber-800">
              <p className="font-medium">Using local MongoDB</p>
              <p className="mt-0.5 text-amber-700">{authStatus.warnings[0]}</p>
            </div>
          ) : null}
          ...
          {hasGoogleProvider ? (
            <Button
              variant="outline"
              className="mb-5 w-full gap-2.5 border-slate-200 bg-white py-5 text-slate-700 shadow-soft transition-all hover:bg-slate-50 hover:border-slate-300 font-medium"
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input id="email" type="email" placeholder="you@example.com" value={email}
                  ...
                  className="pl-10 border-slate-200 bg-white focus:border-indigo-400 focus:ring-indigo-400/20"
          ...
          <p className="mt-6 text-center text-sm text-slate-500">
            ...
            <Link href="/register" className="font-semibold text-indigo-600 hover:text-indigo-700">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
